...
for window in range(N_WINDOWS):
    ...
    left_found_upper_part = ((nz[0] >= win_yl)&(nz[0] < win_yl_part)&(nz[1] >= win_xll)&(nz[1] < win_xlh)).nonzero()[0]
    right_found_upper_part = ((nz[0] >= win_yl)&(nz[0] < win_yl_part)&(nz[1] >= win_xrl)&(nz[1] < win_xrh)).nonzero()[0]
    ...
    cv2.line(sliding_img,(int(IMG_BORDER+prev_center_x),int(win_yh)),(int(IMG_BORDER+current_center_x),int(win_yl)),MAGENTA_COLOR, 2) 
    ...
    cv2.rectangle(sliding_img,(int(IMG_BORDER+win_xll),int(win_yl)),(int(IMG_BORDER+win_xlh),int(win_yh)),left_window_color, 2) 
    cv2.rectangle(sliding_img,(int(IMG_BORDER+win_xrl),int(win_yl)),(int(IMG_BORDER+win_xrh),int(win_yh)),right_window_color, 2) 
