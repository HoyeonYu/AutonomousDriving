...
# IMU Topic Callback for Checking Car Velocity
...
def draw_img(src_img, src_pt, drive_angle, target_y, bin_lane_img, sliding_img):
    ...
    cv2.line(sliding_img, (0, int(HEIGHT - target_y)), (int(IMG_BORDER * 2 + WIDTH), int(HEIGHT - target_y)),
             GRAY_COLOR, 2)
...
def start():
    ...
    while not rospy.is_shutdown():
        ...
        # prev_code_warp_inverse_mat = border_warp_inverse_mat.copy()
